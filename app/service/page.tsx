...
import {IconArrowLeft, IconExchange, IconLocation} from "@tabler/icons-react";
                            ...
                            >
                                ...
                                >
                                    <Image
                                        ...
                                        width={50}
                                        height={50}
                                        className="border border-purple-900 rounded-md px-2 py-2"
                                    />
                                    <p className=" font-Azeret text-gray-600 text-[12px] lg:text-[16px] font-medium">
                                        mine.pi
                                    </p>
                                ...
                                <a
                                    href="/unlock"
                                    className="flex flex-col gap-3 items-center  hover:scale-110 active:scale-105 accent-purple-800 transition-all"
                                >
                                    <IconExchange width={50} height={50} color={`#6b21a8`} className="border border-purple-900 rounded-md px-2 py-2" />
