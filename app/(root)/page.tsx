  ...
  return (
      ...
      >
        ...
        <div className=" bg-purple-600 w-full">
          <div
              className="flex flex-col gap-3 padding-y items-center justify-center text-[20px] sm:text-[32px] font-semibold">
            <motion.p
        ...
        <section className="padding-x lg:px-[450px] bg-white items-center ">
          ...
          <div
              className="flex flex-col justify-center items-center  md:px-[200px] lg:px-0 lg:flex-row gap-5 mt-[100px] pb-5">
            <MiningCards
                index={1 as number}
                icon="/Spinner.png"
                title="Decentralized"
